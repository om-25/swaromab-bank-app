...
<body>
	...
	<div class="container">
		...
		<div class="card shadow  mb-5 bg-body rounded" style="width: 700px">
			<h5 class="card-header" style="height: 70px; font-size: 25px; background-color: #18334f;color: white;">Login</h5>
			...
			<div class="card-body">
				<form role="form" action="<%=IMSView.LOGIN_CTL%>" method="post">
					...
					<input type="submit" name="operation"
								...
								<a href="<%=IMSView.FORGET_PASSWORD_CTL%>"><b>Forget my password?</b></a>
				</form>
			</div>
		</div>
	</div>
